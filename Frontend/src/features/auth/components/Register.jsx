/**
 * LEVEL 1 — UI
 * Register page — jigyaza.ai-style split layout, light theme.
 * Left: dashboard mockup + headline. Right: minimal registration form.
 */
...
/* ── Dashboard mockup (same component reused) ──────────────── */
    ...
    <div className="auth-mockup">
      ...
      <div className="auth-mockup__body">
        ...
        <div className="auth-mockup__chart">
          {[45, 70, 35, 85, 55, 95, 60, 75].map((h, i) => (
            <div
              key={i}
      ...
      <div className="auth-panel-left">
        ...
        <div className="auth-panel-left__bottom">
          ...
          <p className="auth-panel-left__desc">
            Join thousands of teams detecting dark patterns and staying
            compliant with Avarana&apos;s AI-powered platform.
          </p>
        </div>
      </div>
