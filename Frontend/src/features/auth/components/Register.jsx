 ...
 * All logic delegated to useRegister() hook.
 */
...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    const { confirmPassword, ...payload } = form; // strip confirmPassword
    register(payload);
  };
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card auth-card--wide">
        ...
        <h1 className="auth-heading">Join the arena</h1>
        <p className="auth-sub">
          Create your account to start detecting dark patterns.
        </p>
