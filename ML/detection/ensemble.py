...
class EnsembleClassifier:
    ...
    def _infer_subtype(self, attributions: list[SHAPAttribution]) -> str:
        """Infer the most likely dark pattern subtype from SHAP feature contributions."""
        if not attributions:
            return "interface_interference"

        top_feature = attributions[0].feature_name

        # Map feature names to subtypes
        feature_to_subtype = {
        ...
        return feature_to_subtype.get(top_feature, "interface_interference")
