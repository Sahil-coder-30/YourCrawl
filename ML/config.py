...
CANDIDATE_THRESHOLD = 0.4        # Min probability to flag as candidate
...
SIZE_ASYMMETRY_RATIO = 3.0       # Flag if accept button > 3x reject button
...
SENTIMENT_ASYMMETRY_THRESHOLD = 0.4  # Flag if sentiment gap > 0.4
